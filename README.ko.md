...
- `02.Reference_Templete`가 비어 있으면 기본 디자인 기준 사용 전에 사용자 확인
- `DESIGN.md`, `TASK.md` 확정 후 `AGENT.md` 생성
...
슬라이드 생성 단계에서는 Codex가 Stitch를 우선 사용하고, Stitch가 없으면 먼저 설치를 권장한 뒤 필요하면 일반 workflow로 진행합니다.
